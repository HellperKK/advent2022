def range_overlap_range?(range_one, range_two)
...
def has_inclusion?(assignments)
    ...
    range_overlap_range?(first_assignment, second_assignment) || range_overlap_range?( second_assignment, first_assignment)
end
